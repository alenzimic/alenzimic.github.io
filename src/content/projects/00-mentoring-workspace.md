...
This project supports structured mentor-mentee collaboration by keeping progress entries, task ownership, due dates, deadlines, and a searchable timeline in one place. It can run locally for preview or as a shared Google Apps Script web app backed by Google Docs and Google Sheets.
