...
This project is an interactive teaching tool for explaining rotary positional embeddings. It uses deterministic demo vectors, real absolute sinusoidal position addition, real RoPE pair rotation formulas, and heatmaps to compare cosine similarity across transformed vectors.
